...
smaller and smaller boxes centered around the previous moment.
...
def findCenter(image, plot = False, filename = None):
    ...
    if plot and filename is None:
        raise ValueError('Plot is true but no filename given in findCenter.')
...
if __name__ == '__main__':
    ...
    findCenter(image, True, args.savename)
